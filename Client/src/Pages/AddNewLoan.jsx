        ...
        <div className="relative bg-black rounded-lg shadow dark:bg-black">
          ...
          <div className="p-4 md:p-5 space-y-4">
            <p className="text-base leading-relaxed text-white dark:text-white">
              You have successfully added a new loan. The Processing Department
              will start processing the loan. Please take the original loan file
              to the assigned Loan Processor.
            </p>
          </div>
          {/* <!-- Modal footer --> */}
          <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button
              ...
              data-modal-hide="default-modal"
              type="button"
              className="text-black bg-green-600 font-semibold hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg  px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-400 dark:focus:ring-green-600"
            >
              Close
            </button>
          </div>
...
const AddNewLoan = () => {
  ...
  const addNewTask = () => {
    const newTask = loanForm.tasks;
    console.log("newTask", newTask);
    newTask.push({ ...taskForm });
    setLoanForm({ ...loanForm, tasks: newTask });
    setTaskForm({
      taskName: "",
      startDate: "",
      completed: "",
  ...
  return (
    <>
      <SideNavbar />
      <section className="ml-40 bg-cover h-scroll">
            ...
            <form onSubmit={submitForm}>
              ...
              <div className="mb-4 pt-4">
                ...
                <input
                  ...
                  placeholder="Loan Submission Date"
                  value={loanForm.dateSubmitted}
                  onChange={(e) =>
              ...
              {loanForm.tasks.map((task) => (
                  ...
                  <div>
                    ...
                    <input
                      value={
                        task.completed === null
                          ? ""
                          : new Date(task.completed).toLocaleString("en-US", {year: "numeric", month: "2-digit", day: "2-digit"})
                      }
                      onChange={(e) =>
                        setTaskForm({
                          ...loanForm,
               ...
               <button 
                onClick={updateTask}
                type="button"
                className="me-0 bg-green-600 ml-10 mt-9 w-20 h-8 p-0 hover:bg-green-400 border border-black"> Update 
               </button>
               <button 
                onClick={deleteTask}
                type="button"
                className="me-0 bg-green-600 ml-10 mt-9 w-20 h-8 p-0 hover:bg-green-400 border border-black"> Delete 
               </button>
                </div> */}
                </div>
              ))}
